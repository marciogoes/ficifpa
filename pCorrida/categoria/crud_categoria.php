...
if($acao=='listar'){
  ...
  if($r==true) {
    header('Location: crud_categoria.php?acao=listar');
  }else{
  ...
  $qtd   = $query->fetch();
  if($qtd >= 1) {
    header('Location: crud_categoria.php?acao=listar&erro=true');
  }
  ...
  if($r==true) {
    ...
    //** FUNCAO PARA BUSCAR TODOS OS DADOS DA TBL
