<div class="container">
  ...
  href="crud_categoria.php?acao=novo">
...
<tbody>
  <?php foreach($lista_categoria as $item):
    ...
    <tr>
      ...
      <td>
        <a class="btn btn-secondary" href="crud_categoria.php?acao=buscar&id=<?= $id; ?>">
          <span data-feather="edit"></span>
        </a>
      </td>
      <td>
        <a class="btn btn-secondary" href="crud_categoria.php?acao=deletar&id=<?= $id; ?>">
